...
<template>
  <div class="question-container">
    ...
    <div class="options-container">
      <div class="option" v-for="(option, index) in options" :key="index" :style="{ marginTop: '60px' }">
        <el-radio v-model="selectedOption" :label="option.label" class="question-text">{{ option.label }}</el-radio>
  ...
  <div style="margin-top: 30px;float: left;">
    ...
    <el-select v-model="selectedDifficulty" placeholder="请选择难易程度" style="width: 100px;margin-left: 10px;font-size: 20px" >
      <el-option
  ...
  <div class="container" style="margin-top: 100px;margin-left: 10px;">
    ...
    <div class="action-buttons" >
      <el-button type="primary" @click="saveQuestion " style="font-size: 20px">保存出题</el-button>
    </div>
  </div>
