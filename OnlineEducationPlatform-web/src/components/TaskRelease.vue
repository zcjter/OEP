...
export default {
  ...
  methods:{
    ...
    releaseTask(){//发布作业信息
      ...
      this.$axios.post('/task/release', data)
          .then(response => {
            if (response.data.code === 20000) {
              this.classItems = response.data.data;
          ...
          .catch(error => {
            console.error('发布作业信息失败', error);
          });
    },
    genDateTime(timestr){//获取当前时间信息
      const monthMap = {
  ...
  <el-main>
    ...
    <div class="container">
      ...
      <div class="button-container">
        <el-button type="primary" @click="releaseTask">发布作业</el-button>
