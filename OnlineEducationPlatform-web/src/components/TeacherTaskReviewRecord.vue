    ...
    <div v-for="(item, index) in taskData">
      <div class="question-preview">
        ...
        <div class="answer" >
          ...
          <span class="answer-label">{{taskRecordItem.sname}}答案:</span>
